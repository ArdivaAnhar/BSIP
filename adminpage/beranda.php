...
<html lang="en">
    ...
    <head>
        ...
        .bton {
            position: absolute;
            bottom: -80px;
            background-color: rgb(31, 111, 51);
            color: white;
            border: none;
            padding: 10px 20px;
            border-radius: 5px;
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="image-container">
                            <span style="--i: 1">
                                <img width="300" height="130" class="shadow-lg" src="img/img7.jpeg" />
                            </span>
                            <span style="--i: 2">
                                <img width="300" height="130" class="shadow-lg" src="img/img8.jpeg" />
                            </span>
                            <span style="--i: 3">
                                <img width="300" height="130" class="shadow-lg" src="img/img2.jpeg" />
                            </span>
                            <span style="--i: 4">
                                <img width="300" height="130" class="shadow-lg" src="img/img3.jpeg" />
                            </span>
                            <span style="--i: 5">
                                <img width="300" height="130" class="shadow-lg" src="img/img4.jpeg" />
                            </span>
                            <span style="--i: 6">
                                <img width="300" height="130" class="shadow-lg" src="img/img5.jpeg" />
                            </span>
                            <span style="--i: 7">
                                <img width="300" height="130" class="shadow-lg" src="img/img6.jpeg" />
                            </span>
                            <span style="--i: 8">
                                <img width="300" height="130" class="shadow-lg" src="img/img1.jpeg" />
                            </span>
                        </div>
                        <div class="bton-container">
                            <button class="bton" id="prev" hidden>Prev</button>
                            <button class="bton" id="next" hidden>Next</button>
                        </div>
